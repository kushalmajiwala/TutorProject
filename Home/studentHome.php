...
<head>
    ...
    <style>
        ...
        .edit, .find, .bookmark, .feedback, .request, .bookedtut{
          display: none;
        }
        body{
        ...
        input[type=text], input[type=password], input[type=email], input[type=tel], .lst {
          width: 60%;
          padding: 12px 20px;
          margin: 8px 0;
...
<div class="edit">
  ...
  <center>
      <div class="container frmClass">
        ...
        <input type="password" placeholder="Enter Password" name="psw" minlength="8"  value="<?php echo $pass;?>" required><br>
        ...
        <label for="city"><i class='material-icons' style='font-size:24px'>location_city</i></label>
        <select name="city" class="lst">
          <?php
...
<div class="find">
 <center>
   <h1>Filter Tutor</h1>
<form method="get" action="filterStudentHome.php">
  <div class="table-responsive">
 <label for="filtsub"><i class='fas fa-book' style='font-size:24px'></i></label>
      <select name="filtsub" class="filtsub">
      ...
      <label for="filtcity"><i class='fas fa-city' style='font-size:24px'></i></label>
      <select name="filtcity" class="filtsub">
      ...
      <label for="filtfee"><i class='fas fa-sort' style='font-size:24px'></i></label>
      <select name="filtfee" class="filtsub">
        <option disabled selected>Choose-Fee-Order</option>
   ...
   <div class="container">
      <?php
        $sql = "select t.tid, t.fname, t.lname, t.pic, s.subName, t.email, t.mobno, t.qual, t.address, c.cityName, avg(r.rating), t.fee, st.status from tutortb t, ratingtb r, statusmaster st, citymaster c, subjectmaster s where t.subID = s.subID and t.cityID = c.cityID and t.statusID = st.statusID and r.tid = t.tid group by tid";
        $res = mysqli_query($con, $sql);
          ...
          ?>
            <div class="table-responsive mytb">
              <table class='table'>
                ...
                <tr>
                  <th>Rating :- </th>
                  <td><?php if($tut[10] == null){ echo "Not Rated yet...";}else{ echo number_format($tut[10], 1, '.', ''), "/5.0"; } ?></td>
                </tr>
                <tr>
                  <th>Fee :- </th>
            ...
            ?>
              <div class="table-responsive mytb">
                <table class='table'>
                  ...
                  <tr>
                    <th>Rating :- </th>
                    <td><?php if($booktut[10] == null){ echo "Not Rated yet...";}else{ echo number_format($booktut[10], 1, '.', ''), "/5.0"; } ?></td>
                  </tr>
                  <tr>
                    <th>Fee :- </th>
    ...
    <table class="table">
      ...
      <tbody>
        <?php
          ...
          {
            echo "<html><center><h1>No Booked Tutors</h1></center></html>";
          }
        ?>
      </tbody>
    </table>
            ...
            ?>
              <div class="table-responsive mytb">
                <table class='table'>
                  ...
                  <tr>
                    <th>Rating :- </th>
                    <td><?php if($reqtut[10] == null){ echo "Not Rated yet...";}else{ echo number_format($reqtut[10], 1, '.', ''), "/5.0"; } ?></td>
                  </tr>
                  <tr>
                    <th>Fee :- </th>
