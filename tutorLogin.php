...
<center>
    <div class="container frmClass">
      ...
      <input type="password" placeholder="Enter Password" name="registerpsw" minlength="8" required><br>
          
      <label for="registerconfpsw"><i class='fas fa-user-lock' style='font-size:24px'></i></label>
      <input type="password" placeholder="Re-Enter Password" name="registerconfpsw" minlength="8" required><br>
      ...
      <label for="registersub"><i class='fas fa-book' style='font-size:24px'></i></label>
      ...
      <label for="registercity"><i class='fas fa-city' style='font-size:24px'></i></label>
